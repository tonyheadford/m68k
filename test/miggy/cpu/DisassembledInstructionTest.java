...
public class DisassembledInstructionTest {
    ...
    @Test
    public void testDisasmOutputAlignment() {
        ...
        for (int i = 0; i < limit;) {
            ...
            Assert.assertFalse(Character.isLetterOrDigit(str.charAt(33)));
            Assert.assertFalse(Character.isLetterOrDigit(str.charAt(34)));
            Assert.assertTrue(Character.isLetterOrDigit(str.charAt(35)));
            Assert.assertTrue(Character.isLetterOrDigit(str.charAt(36)));
